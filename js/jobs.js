...
Object.keys(defaultJobs).map(function(key, index) {
  // assign the current aptitudes to defaults so we have a point of reference in multiplier calculations
  defaultJobs[key].defaultAptitudes = {};
  Object.assign(defaultJobs[key].defaultAptitudes, defaultJobs[key].aptitudes);
  defaultJobs[key].multis = {};
  defaultJobs[key].powerLevel = Object.values(defaultJobs[key].defaultAptitudes).reduce(function(a,b) {return a + b;}, 0);
});
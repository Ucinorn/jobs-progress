...
Object.keys(perks).map(function (key, index) {
  if (typeof perks[key].check == 'undefined') {
    perks[key].check = function () { };
  }
  if (typeof perks[key].onQuestComplete == 'undefined') {
    perks[key].onQuestComplete = function () { };
  }
  if (typeof perks[key].onLevelUp == 'undefined') {
    perks[key].onLevelUp = function () { };
  }
  if (typeof perks[key].onPlayerLevelUp == 'undefined') {
    perks[key].onPlayerLevelUp = function () { };
  }
});
